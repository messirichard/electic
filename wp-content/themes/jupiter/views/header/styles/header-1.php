                ...
                <div class="mk-header-inner add-header-height">
                    ...
                    <?php } ?>
                            <div class="mk-header-nav-container one-row-style menu-hover-style-<?php echo esc_attr( $header_class['sh_hover_styles'] ); ?>" <?php echo get_schema_markup('nav'); ?>>   
                                <div style="margin-top:15px;margin-bottom:-10px;margin-right: 20px;">
                                    <ul stlye="list-style:none;">
                                        <li style="display:inline-block;font-size:13px;font-family:'Rubik',sans-serif;font-weight:bold;">
                                            CALL US NOW
                                        </li>
                                        <li style="display:inline-block;font-size:13px;font-family:'Rubik',sans-serif;font-weight:bold;">
                                            <img src="http://localhost/electic/wp-content/uploads/2018/10/png-1.png" alt="">
                                        </li>
                                        <li style="color:#ed3338;display:inline-block;font-size:13px;font-family:'Rubik',sans-serif;font-weight:bold;">
                                            081 211 78899
                                        </li>
                                        <li style="display:inline-block;font-size:13px;font-family:'Rubik',sans-serif;font-weight:bold;">
                                            <img src="http://localhost/electic/wp-content/uploads/2018/10/telegram-logo.png" alt="">
                                        </li>
                                        <li style="color:#ed3338;margin-right:20px;display:inline-block;font-size:13px;font-family:'Rubik',sans-serif;font-weight:bold;">
                                            info@eclectic.co.id
                                        </li>
                                        <li style="margin: 0 5px; display: inline-block;"><a href="#"><img src="http://localhost/electic/wp-content/uploads/2018/10/instagram-symbol.png" alt="" /></a>
                                        </li>
                                        <li style="margin: 0 5px; display: inline-block;"><a href="#"><img class="" src="http://localhost/electic/wp-content/uploads/2018/10/facebook-logo.png" alt="" /></a></li>
                                        <li style="margin: 0 5px; display: inline-block;"><a href="#"><img src="http://localhost/electic/wp-content/uploads/2018/10/linkedin-logo.png" alt="" /></a></li>
                                    </ul>
                                </div>          
                                <?php
