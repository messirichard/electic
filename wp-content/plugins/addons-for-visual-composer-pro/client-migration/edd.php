<?php
     ...
     */
    class LVCA_EDD_License_Key extends FS_Client_License_Abstract_v1 {
        /**
        ...
        function get( $blog_id = null ) {
            return trim( get_option( 'lvca_license_key', '' ) );
        }
        ...
        function set( $license_key, $blog_id = null ) {
            return update_option( 'lvca_license_key', $license_key );
        }
    ...
    new FS_EDD_Client_Migration_v1(
        ...
        'https://www.livemeshthemes.com',

        // The EDD download ID of your product.
        '1905',

        new LVCA_EDD_License_Key(),
