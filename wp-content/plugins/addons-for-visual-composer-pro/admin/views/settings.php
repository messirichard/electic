...
if (lvca_fs()->can_use_premium_code__premium_only()) {

    /* ---------- Pro Elements --------- */

    $deactivate_element_posts_block = lvca_get_option('lvca_deactivate_element_posts_block', false);

    $deactivate_element_faq = lvca_get_option('lvca_deactivate_element_faq', false);

    $deactivate_element_countdown = lvca_get_option('lvca_deactivate_element_countdown', false);

    $deactivate_element_features = lvca_get_option('lvca_deactivate_element_features', false);

    $deactivate_element_button = lvca_get_option('lvca_deactivate_element_button', false);

    $deactivate_element_gallery_carousel = lvca_get_option('lvca_deactivate_element_gallery_carousel', false);

    $deactivate_element_gallery = lvca_get_option('lvca_deactivate_element_gallery', false);

    $deactivate_element_icon_list = lvca_get_option('lvca_deactivate_element_icon_list', false);

    $deactivate_element_image_slider = lvca_get_option('lvca_deactivate_element_image_slider', false);

    $deactivate_element_slider = lvca_get_option('lvca_deactivate_element_slider', false);
                ...
                <div class="lvca-tab-content elements">
                    ...
                    <div class="lvca-inner lvca-box-inner">
                        ...
                        <div class="lvca-elements-deactivate">
                            ...
                            <?php if (lvca_fs()->can_use_premium_code__premium_only()): ?>
    
                                <div class="lvca-row lvca-type-checkbox lvca-field">
                                    <label class="lvca-label"><?php echo __('Deactivate Posts Block', 'livemesh-vc-addons') ?></label>
                                    <p class="lvca-desc"><?php echo __('Deactivate the posts block element.', 'livemesh-vc-addons') ?></p>
                                    <div class="lvca-spacer" style="height: 5px"></div>
                                    <div class="lvca-toggle">
                                        <input type="checkbox" class="lvca-checkbox"
                                               name="lvca_deactivate_element_posts_block"
                                               id="lvca_deactivate_element_posts_block" data-default=""
                                               value="<?php echo $deactivate_element_posts_block ?>" <?php echo checked(!empty($deactivate_element_posts_block), 1, false) ?>>
                                        <label for="lvca_deactivate_element_posts_block"></label>
                                    </div>
                                </div>
    
                                <div class="lvca-row lvca-type-checkbox lvca-field">
                                    <label class="lvca-label"><?php echo __('Deactivate FAQ', 'livemesh-vc-addons') ?></label>
                                    <p class="lvca-desc"><?php echo __('Deactivate the faq element.', 'livemesh-vc-addons') ?></p>
                                    <div class="lvca-spacer" style="height: 5px"></div>
                                    <div class="lvca-toggle">
                                        <input type="checkbox" class="lvca-checkbox"
                                               name="lvca_deactivate_element_faq"
                                               id="lvca_deactivate_element_faq" data-default=""
                                               value="<?php echo $deactivate_element_faq ?>" <?php echo checked(!empty($deactivate_element_faq), 1, false) ?>>
                                        <label for="lvca_deactivate_element_faq"></label>
                                    </div>
                                </div>
    
                                <div class="lvca-row lvca-type-checkbox lvca-field">
                                    <label class="lvca-label"><?php echo __('Deactivate Countdown', 'livemesh-vc-addons') ?></label>
                                    <p class="lvca-desc"><?php echo __('Deactivate the countdown element.', 'livemesh-vc-addons') ?></p>
                                    <div class="lvca-spacer" style="height: 5px"></div>
                                    <div class="lvca-toggle">
                                        <input type="checkbox" class="lvca-checkbox"
                                               name="lvca_deactivate_element_countdown"
                                               id="lvca_deactivate_element_countdown" data-default=""
                                               value="<?php echo $deactivate_element_countdown ?>" <?php echo checked(!empty($deactivate_element_countdown), 1, false) ?>>
                                        <label for="lvca_deactivate_element_countdown"></label>
                                    </div>
                                </div>
    
                                <div class="lvca-row lvca-type-checkbox lvca-field">
                                    <label class="lvca-label"><?php echo __('Deactivate Features', 'livemesh-vc-addons') ?></label>
                                    <p class="lvca-desc"><?php echo __('Deactivate the features element.', 'livemesh-vc-addons') ?></p>
                                    <div class="lvca-spacer" style="height: 5px"></div>
                                    <div class="lvca-toggle">
                                        <input type="checkbox" class="lvca-checkbox"
                                               name="lvca_deactivate_element_features"
                                               id="lvca_deactivate_element_features" data-default=""
                                               value="<?php echo $deactivate_element_features ?>" <?php echo checked(!empty($deactivate_element_features), 1, false) ?>>
                                        <label for="lvca_deactivate_element_features"></label>
                                    </div>
                                </div>
    
                                <div class="lvca-row lvca-type-checkbox lvca-field">
                                    <label class="lvca-label"><?php echo __('Deactivate Button', 'livemesh-vc-addons') ?></label>
                                    <p class="lvca-desc"><?php echo __('Deactivate the button element.', 'livemesh-vc-addons') ?></p>
                                    <div class="lvca-spacer" style="height: 5px"></div>
                                    <div class="lvca-toggle">
                                        <input type="checkbox" class="lvca-checkbox"
                                               name="lvca_deactivate_element_button"
                                               id="lvca_deactivate_element_button" data-default=""
                                               value="<?php echo $deactivate_element_button ?>" <?php echo checked(!empty($deactivate_element_button), 1, false) ?>>
                                        <label for="lvca_deactivate_element_button"></label>
                                    </div>
                                </div>
    
                                <div class="lvca-row lvca-type-checkbox lvca-field">
                                    <label class="lvca-label"><?php echo __('Deactivate Gallery Carousel', 'livemesh-vc-addons') ?></label>
                                    <p class="lvca-desc"><?php echo __('Deactivate the gallery carousel element.', 'livemesh-vc-addons') ?></p>
                                    <div class="lvca-spacer" style="height: 5px"></div>
                                    <div class="lvca-toggle">
                                        <input type="checkbox" class="lvca-checkbox"
                                               name="lvca_deactivate_element_gallery_carousel"
                                               id="lvca_deactivate_element_gallery_carousel" data-default=""
                                               value="<?php echo $deactivate_element_gallery_carousel ?>" <?php echo checked(!empty($deactivate_element_gallery_carousel), 1, false) ?>>
                                        <label for="lvca_deactivate_element_gallery_carousel"></label>
                                    </div>
                                </div>
    
                                <div class="lvca-row lvca-type-checkbox lvca-field">
                                    <label class="lvca-label"><?php echo __('Deactivate Gallery', 'livemesh-vc-addons') ?></label>
                                    <p class="lvca-desc"><?php echo __('Deactivate the gallery element.', 'livemesh-vc-addons') ?></p>
                                    <div class="lvca-spacer" style="height: 5px"></div>
                                    <div class="lvca-toggle">
                                        <input type="checkbox" class="lvca-checkbox"
                                               name="lvca_deactivate_element_gallery"
                                               id="lvca_deactivate_element_gallery" data-default=""
                                               value="<?php echo $deactivate_element_gallery ?>" <?php echo checked(!empty($deactivate_element_gallery), 1, false) ?>>
                                        <label for="lvca_deactivate_element_gallery"></label>
                                    </div>
                                </div>
    
                                <div class="lvca-row lvca-type-checkbox lvca-field">
                                    <label class="lvca-label"><?php echo __('Deactivate Icon List', 'livemesh-vc-addons') ?></label>
                                    <p class="lvca-desc"><?php echo __('Deactivate the icon list element.', 'livemesh-vc-addons') ?></p>
                                    <div class="lvca-spacer" style="height: 5px"></div>
                                    <div class="lvca-toggle">
                                        <input type="checkbox" class="lvca-checkbox"
                                               name="lvca_deactivate_element_icon_list"
                                               id="lvca_deactivate_element_icon_list" data-default=""
                                               value="<?php echo $deactivate_element_icon_list ?>" <?php echo checked(!empty($deactivate_element_icon_list), 1, false) ?>>
                                        <label for="lvca_deactivate_element_icon_list"></label>
                                    </div>
                                </div>
    
                                <div class="lvca-row lvca-type-checkbox lvca-field">
                                    <label class="lvca-label"><?php echo __('Deactivate Image Slider', 'livemesh-vc-addons') ?></label>
                                    <p class="lvca-desc"><?php echo __('Deactivate the image slider element.', 'livemesh-vc-addons') ?></p>
                                    <div class="lvca-spacer" style="height: 5px"></div>
                                    <div class="lvca-toggle">
                                        <input type="checkbox" class="lvca-checkbox"
                                               name="lvca_deactivate_element_image_slider"
                                               id="lvca_deactivate_element_image_slider" data-default=""
                                               value="<?php echo $deactivate_element_image_slider ?>" <?php echo checked(!empty($deactivate_element_image_slider), 1, false) ?>>
                                        <label for="lvca_deactivate_element_image_slider"></label>
                                    </div>
                                </div>
    
                                <div class="lvca-row lvca-type-checkbox lvca-field">
                                    <label class="lvca-label"><?php echo __('Deactivate Slider', 'livemesh-vc-addons') ?></label>
                                    <p class="lvca-desc"><?php echo __('Deactivate the slider element.', 'livemesh-vc-addons') ?></p>
                                    <div class="lvca-spacer" style="height: 5px"></div>
                                    <div class="lvca-toggle">
                                        <input type="checkbox" class="lvca-checkbox"
                                               name="lvca_deactivate_element_slider"
                                               id="lvca_deactivate_element_slider" data-default=""
                                               value="<?php echo $deactivate_element_slider ?>" <?php echo checked(!empty($deactivate_element_slider), 1, false) ?>>
                                        <label for="lvca_deactivate_element_slider"></label>
                                    </div>
                                </div>
                    ...
                    <div class="lvca-inner lvca-box-inner">
                        ...
                        <div class="lvca-row lvca-field lvca_premium_version">
                            ...
                            <?php if (lvca_fs()->is_not_paying()): ?>
                                ...
                                <label class="lvca-label"><?php echo __('Why upgrade to Premium Version of the plugin?!', 'livemesh-vc-addons') ?></label>

                            <?php else: ?>

                                <label class="lvca-label"><?php echo __('Thanks for upgrading to the Premium Version of the plugin!', 'livemesh-vc-addons') ?></label>
                            ...
                            <?php if (lvca_fs()->is_not_paying()): ?>
                                ...
                                <a class="lvca-button purchase" href="<?php echo lvca_fs()->get_upgrade_url(); ?>"><i class="dashicons dashicons-cart"></i><?php echo __('Purchase Now', 'livemesh-vc-addons'); ?></a>
                            ...
                            <?php if (lvca_fs()->is_not_paying()): ?>
                                ...
                                <a class="lvca-button purchase" href="<?php echo lvca_fs()->get_upgrade_url(); ?>"><i class="dashicons dashicons-cart"></i><?php echo __('Go Premium', 'livemesh-vc-addons'); ?></a>

                            <?php else: ?>

                                <a class="lvca-button know-more" href="https://www.livemeshthemes.com/wpbakery-page-builder-addons/"><i class="dashicons dashicons-external"></i><?php echo __('Know More', 'livemesh-vc-addons'); ?></a>
