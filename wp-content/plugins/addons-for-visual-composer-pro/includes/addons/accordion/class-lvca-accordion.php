...
class LVCA_Accordion {
    ...
    function load_scripts() {
        ...
        if (lvca_fs()->can_use_premium_code__premium_only()) {
            wp_enqueue_script('lvca-premium-frontend-scripts', LVCA_PLUGIN_URL . 'assets/js/premium/lvca-frontend' . LVCA_JS_SUFFIX . '.js', array('jquery'), LVCA_VERSION, true);
        }
    ...
    public function shortcode_func($atts, $content = null, $tag) {
        ...
        <div class="lvca-accordion lvca-<?php echo $style; ?>"
             data-toggle="<?php echo ($toggle ? "true" : "false"); ?>"
    ...
    public function child_shortcode_func($atts, $content = null, $tag) {
        ...
        <div class="lvca-panel" id="<?php echo $panel_id; ?>">
