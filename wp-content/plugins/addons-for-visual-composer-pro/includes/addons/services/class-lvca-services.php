...
class LVCA_Services {
    ...
    function load_scripts() {
        ...
        wp_enqueue_script('lvca-services', plugin_dir_url(__FILE__) . 'js/services' . LVCA_JS_SUFFIX . '.js', array('jquery'), LVCA_VERSION);
    ...
    public function shortcode_func($atts, $content = null, $tag) {
        ...
        <div id="lvca-services<?php echo uniqid(); ?>" data-settings='<?php echo htmlspecialchars(json_encode($settings)); ?>' class="lvca-services lvca-<?php echo $settings['style']; ?> lvca-grid-container <?php echo lvca_get_grid_classes($settings); ?>">
    ...
    public function child_shortcode_func($atts, $content = null, $tag) {
        ...
        <div class="lvca-grid-item lvca-service-wrapper">
            ...
            <div class="lvca-service <?php echo $animate_class; ?>" <?php echo $animation_attr; ?>>
