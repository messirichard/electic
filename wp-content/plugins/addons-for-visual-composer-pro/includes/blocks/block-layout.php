...
class LVCA_Block_Layout {
    ...
    function open_row() {
        ...
        return '<div class="lvca-block-row">';
    }
    ...
    function open_column($column_class, $additional_class = '') {
        ...
        return '<div class="lvca-block-column ' . ($additional_class !== '' ? $additional_class . ' ' : '') . $column_class . '">';
