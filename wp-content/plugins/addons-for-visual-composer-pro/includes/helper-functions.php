...
function lvca_get_animation_options() {
    ...
    if (lvca_fs()->can_use_premium_code__premium_only()) {
        return array(
            ...
            'bounce' => __('Bounce', 'livemesh-vc-addons'),
            'flash' => __('Flash', 'livemesh-vc-addons'),
            'pulse' => __('Pulse', 'livemesh-vc-addons'),
            'swing' => __('Swing', 'livemesh-vc-addons'),
            'shake' => __('Shake', 'livemesh-vc-addons'),
            'tada' => __('Tada', 'livemesh-vc-addons'),
            'wobble' => __('Wobble', 'livemesh-vc-addons'),
            'jello' => __('Jello', 'livemesh-vc-addons'),
            'rubberBand' => __('Rubber Band', 'livemesh-vc-addons'),
            'bounceIn' => __('Bounce In', 'livemesh-vc-addons'),
            'bounceInLeft' => __('Bounce In Left', 'livemesh-vc-addons'),
            'bounceInRight' => __('Bounce In Right', 'livemesh-vc-addons'),
            'bounceInDown' => __('Bounce In Down', 'livemesh-vc-addons'),
            'bounceInUp' => __('Bounce In Up', 'livemesh-vc-addons'),
            'fadeIn' => __('Fade In', 'livemesh-vc-addons'),
            'fadeInLeft' => __('Fade In Left', 'livemesh-vc-addons'),
            'fadeInLeftBig' => __('Fade In Left Big', 'livemesh-vc-addons'),
            'fadeInRight' => __('Fade In Right', 'livemesh-vc-addons'),
            'fadeInRightBig' => __('Fade In Right Big', 'livemesh-vc-addons'),
            'fadeInUp' => __('Fade In Up', 'livemesh-vc-addons'),
            'fadeInUpBig' => __('Fade In Up Big', 'livemesh-vc-addons'),
            'fadeInDown' => __('Fade In Down', 'livemesh-vc-addons'),
            'fadeInDownBig' => __('Fade In Down Big', 'livemesh-vc-addons'),
            'flip' => __('Flip', 'livemesh-vc-addons'),
            'flipInX' => __('Flip In X', 'livemesh-vc-addons'),
            'flipInY' => __('Flip In Y', 'livemesh-vc-addons'),
            'lightSpeedIn' => __('Light Speed In', 'livemesh-vc-addons'),
            'rotateIn' => __('Rotate In', 'livemesh-vc-addons'),
            'rotateInUpLeft' => __('Rotate In Up Left', 'livemesh-vc-addons'),
            'rotateInUpRight' => __('Rotate In Up Right', 'livemesh-vc-addons'),
            'rotateInDownLeft' => __('Rotate In Down Left', 'livemesh-vc-addons'),
            'rotateInDownRight' => __('Rotate In Down Right', 'livemesh-vc-addons'),
            'slideInLeft' => __('Slide In Left', 'livemesh-vc-addons'),
            'slideInRight' => __('Slide In Right', 'livemesh-vc-addons'),
            'slideInDown' => __('Slide In Down', 'livemesh-vc-addons'),
            'slideInUp' => __('Slide In Up', 'livemesh-vc-addons'),
            'zoomIn' => __('Zoom In', 'livemesh-vc-addons'),
            'zoomInLeft' => __('Zoom In Left', 'livemesh-vc-addons'),
            'zoomInRight' => __('Zoom In Right', 'livemesh-vc-addons'),
            'zoomInDown' => __('Zoom In Down', 'livemesh-vc-addons'),
            'zoomInUp' => __('Zoom In Up', 'livemesh-vc-addons'),
            'rollIn' => __('Roll In', 'livemesh-vc-addons'),
        );
    }
    else {
        return array(
