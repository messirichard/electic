        ...
        switch ( $item['item_type'] ) {
            case 'youtube':
                ...
                if ($result) {
                    ...
                    $output = '<div class="lvca-youtube-video"><iframe src="https://youtube.com/embed/' . $result['video_id'] . '" frameborder="0" allowfullscreen></iframe></div>';
                }
                break;
            case 'vimeo':
                // Check if the URL is a video and a supported video type
                ...
                if ($result) {
                    ...
                    $output = '<div class="lvca-vimeo-video"><iframe src="//player.vimeo.com/video/' . $result['video_id'] . '" frameborder="0" allowfullscreen></iframe></div>';
                }
                break;
            case 'wistia':
            ...
            case 'html5video':
                ...
                $output = '<div class="lvca-html5-video">';

                $output .= '<video controls controlslist="nodownload" class="lvca-html5video" preload="metadata" poster="' . $poster . '">';
