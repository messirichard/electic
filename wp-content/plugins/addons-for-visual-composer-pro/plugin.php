    ...
    final class Livemesh_VC_Addons {
        ...
        public function includes() {
            ...
            if (lvca_fs()->can_use_premium_code__premium_only()) {
                ...
                require_once LVCA_PLUGIN_DIR . 'includes/gallery/common.php';
                require_once LVCA_PLUGIN_DIR . 'includes/gallery/video.php';

                require_once LVCA_PLUGIN_DIR . 'includes/blocks/blocks-init.php';
        ...
        public function include_elements() {
            ...
            if (lvca_fs()->can_use_premium_code__premium_only()) {
                ...
                if (!$deactivate_element_portfolio)
                    require_once LVCA_PREMIUM_ADDONS_DIR . 'portfolio/class-lvca-portfolio.php';
            }
            else {
            ...
            if (lvca_fs()->can_use_premium_code__premium_only()) {
                ...
                if (!$deactivate_element_image_slider)
                    require_once LVCA_PREMIUM_ADDONS_DIR . 'image-slider/class-lvca-image-slider.php';

                $deactivate_element_slider = lvca_get_option('lvca_deactivate_element_slider', false);
                if (!$deactivate_element_slider)
                    require_once LVCA_PREMIUM_ADDONS_DIR . 'slider/class-lvca-slider.php';
        ...
        public function load_frontend_scripts() {
            ...
            wp_register_style('lvca-animate-styles', LVCA_PLUGIN_URL . 'assets/css/animate.css', array(), LVCA_VERSION);
            ...
            wp_enqueue_script('waypoints'); // provided by WPBakery Page Builder itself
